...
extern void tfm_dp_req_mngr_init(void);
...
struct partition_tfm_sp_dp_load_info_t {
    ...
    struct service_load_info_t      services[TFM_SP_DP_NSERVS];
#if TFM_LVL == 3
...
const struct partition_tfm_sp_dp_load_info_t tfm_sp_dp_load
    ...
    .load_info = {
        ...
        .entry                      = ENTRY_TO_POSITION(tfm_dp_req_mngr_init),
        .stack_size                 = 0x800,
        .heap_size                  = 0,
    ...
    .services = {
        {
            .name_strid             = STRING_PTR_TO_STRID("TFM_DP_SECRET_DIGEST"),
            .signal                 = TFM_DP_SECRET_DIGEST_SIGNAL,
            .sid                    = 0xFFFFF001,
            .flags                  = 0
...
__root
#endif /* __ICCARM__ */
static struct service_t tfm_sp_dp_service_runtime_item[TFM_SP_DP_NSERVS]
