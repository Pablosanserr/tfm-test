...
/******** TFM_SP_DP ********/
psa_status_t tfm_dp_secret_digest_req(psa_invec *, size_t, psa_outvec *, size_t);
...
/******** TFM_SP_DP ********/
TFM_VENEER_FUNCTION(TFM_SP_DP, tfm_dp_secret_digest_req, tfm_dp_secret_digest_req)
