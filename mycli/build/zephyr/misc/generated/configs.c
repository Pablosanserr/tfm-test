...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART1_TXD_PIN, 25);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART1_RXD_PIN, 26);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_KEY_TYPE_CAMELLIA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_KEY_TYPE_CHACHA20, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_KEY_TYPE_DES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_PARTITION_AUDIT_LOG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_TFM_SRAM, 0x40000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PSA_BUILTIN_RSA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PSA_BUILTIN_KEY_TYPE_CAMELLIA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PSA_BUILTIN_KEY_TYPE_DES, 1);
